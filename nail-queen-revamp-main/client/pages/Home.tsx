...
export default function Home() {
  useEffect(() => {
    ...
    const existingWidgets = document.querySelectorAll('.ti-widget, .trustindex-widget, [class*="trustindex"]');
    existingWidgets.forEach(widget => {
      if (widget.id !== 'trustindex-container') {
        widget.remove();
            ...
            <div>
              ...
              <div className="space-y-6">
                <p className="text-gray-600 leading-relaxed">
                  Nail Queen was founded a humble 300 sqft space on the 4th
                  floor of Far East Plaza, with just 4 staff and a dream.
                </p>
                <p className="text-gray-600 leading-relaxed">
                  With years of industry experience, Nail Queen is the go-to
                  destination for all your beauty needs. We specialize in nail
                  care, offering exceptional manicures and pedicures, as well as
                  waxing services.
                </p>
                <p className="text-gray-600 leading-relaxed">
                  Our expert staff is committed to providing top-notch service
                  and ensuring each client's unique style and individual needs
                  are met.
                </p>
                <p className="text-gray-600 leading-relaxed">
                  At Nail Queen, we aim to create a world of comfort,
                  relaxation, and rejuvenation for our valued customers.
                </p>
              </div>
            </div>
      ...
      <section className="py-20 bg-background">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row gap-16 items-start">
            ...
            {/* Right Column - Services Grid (80% width) */}
            <div className="w-full md:w-4/5 grid grid-cols-2 gap-6">
              {/* Manicures */}
              <div className="bg-white rounded-lg overflow-hidden shadow-lg">
                <div className="aspect-square bg-gray-200">
                  <img
                    // src="https://images.unsplash.com/photo-1604654894610-df63bc536371?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80"
                ...
                <div className="p-4">
                  ...
                  <p className="text-gray-600 text-sm mb-4">
                    Experience meticulous nail care and stunning nail art
                    designs that reflect your unique style and personality,
                    using top-quality products for long-lasting results.
                  </p>
              ...
              <div className="bg-white rounded-lg overflow-hidden shadow-lg">
                <div className="aspect-square bg-gray-200">
                  <img
                    // src="https://images.unsplash.com/photo-1595348020949-87cdfbb44174?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80"
                ...
                <div className="p-4">
                  ...
                  <p className="text-gray-600 text-sm mb-4">
                    Pamper your feet with our luxurious pedicure treatments,
                    including exfoliation, massage therapy, and expert nail
                    care, leaving you with healthy, beautiful feet.
                  </p>
                  <button className="text-nail-queen-brown text-sm font-medium hover:underline">
                    Learn more
                  </button>
              ...
              <div className="bg-white rounded-lg overflow-hidden shadow-lg">
                ...
                <div className="p-4">
                  ...
                  <p className="text-gray-600 text-sm mb-4">
                    Clean up stray hairs and define your features with our quick
                    shave, brow shaping, and precise threading services for a
                    neat, polished look.
                  </p>
                  <button className="text-nail-queen-brown text-sm font-medium hover:underline">
                    Learn more
              ...
              {/* <div className="bg-white rounded-lg overflow-hidden shadow-lg">
                ...
                <div className="p-4">
                  ...
                  <p className="text-gray-600 text-sm mb-4">
                    Enhance your eyes with natural-looking or voluminous lash
                    extensions. Applied strand by strand for a lightweight,
                    long-lasting, and eye-opening effect.
                  </p>
                  <button className="text-nail-queen-brown text-sm font-medium hover:underline">
                    Learn more
                  </button>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="text-center flex flex-col">
              ...
              <p className="text-gray-600 text-sm mb-6 flex-grow min-h-[120px]">
                No hidden agendas, just beautiful nails. Unlike package pushing
                salons, we believe in clear pricing and personalized
                recommendations. Choose any service you desire, knowing exactly
            ...
            <div className="text-center flex flex-col">
              ...
              <p className="text-gray-600 text-sm mb-6 flex-grow min-h-[120px]">
                Our dedicated staff go the extra mile to ensure your comfort and
                satisfaction, providing a first-class service that leaves you
      ...
      <section className="py-20 relative">
        <div
          ...
          style={{
            ...
            backgroundImage: `url('/assets/review-section.jpg')`,
          }}
        />
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-white">
          ...
          {/* Trustindex.io Widget with Original Design Styling */}
