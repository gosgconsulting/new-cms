          ...
          <div className="grid lg:grid-cols-2 gap-8">
            ...
            <div className="bg-white rounded-3xl p-8 shadow-lg">
              <div className="aspect-square bg-gray-200 rounded-2xl mb-6 overflow-hidden">
                <img 
                  src="/assets/pricing/manicure.jpg"
                  alt="Manicures"
              ...
              <p className="text-gray-600 mb-8">
                Indulge your hands with our different manicure options, from quick and
                efficient to thorough and luxurious.
              </p>
              ...
              <div className="space-y-6">
                <div className="flex justify-between items-start">
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-600">
                      Perfect for those on the go, this service includes cut,
                      shape, and a coat of vibrant NON GEL colour.
                    </p>
                  </div>
                ...
                <div className="flex justify-between items-start">
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-600">
                      An upgrade on our Express Manicure, the Classic
                      includes cuticle care and a soothing lotion massage
                      in addition to cut, shape, and NON GEL colour application.
                    </p>
                  </div>
                  <div className="text-right ml-4">
                ...
                <div className="flex justify-between items-start">
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-600">
                      Get a long-lasting, glossy finish with our Express Gel Manicure.
                      The service involves cutting and shaping nails,
                      followed by the application of GEL colour.
                    </p>
                  </div>
                  <div className="text-right ml-4">
                ...
                <div className="flex justify-between items-start">
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-600">
                      Experience a full package of nail care, featuring cut, shape,
                      cuticle care, GEL colour application, and lotion massage.
                    </p>
                  </div>
                  <div className="text-right ml-4">
                ...
                <div className="flex justify-between items-start">
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-600">
                      Builder in a bottle gel application for stronger, 
                      healthier nails with a natural-looking finish.
                    </p>
                  </div>
                  <div className="text-right ml-4">
                ...
                <div className="flex justify-between items-start">
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-600">
                      Precision cuticle care using specialized tools for a clean,
                      polished look around the nail bed.
                    </p>
                  </div>
                  <div className="text-right ml-4">
                    <span className="font-bold">$74.12</span>
                ...
                <div className="flex justify-between items-start">
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-600">
                      Fill up the growing gap part and create a smooth nail surface.
                    </p>
                  </div>
                  <div className="text-right ml-4">
                ...
                <div className="flex justify-between items-start">
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-600">
                      Make your short nails longer and create an apex
                      for your nails using nail tip extension.
                    </p>
                  </div>
                  <div className="text-right ml-4">
                    <span className="font-bold">extra $95.92/set</span>
                ...
                <div className="flex justify-between items-start">
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-600">
                      Restore a balanced nail surface with our nail
                ...
                <div className="flex justify-between items-start">
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-600">
                      Experience overlays using hard gel, no need for curing lamp,
                      no need for coloured polish.
                    </p>
                  </div>
                  <div className="text-right ml-4">
            ...
            <div className="bg-white rounded-3xl p-8 shadow-lg">
              <div className="aspect-square bg-gray-200 rounded-2xl mb-6 overflow-hidden">
                <img 
                  src="/assets/pricing/pedicure.png"
                  alt="Pedicures"
                  className="w-full h-full object-cover"
                />
              </div>
              ...
              <p className="text-gray-600 mb-8">
                Treat your feet to a spa-like experience with our range of pedicure services.
              </p>
              ...
              <div className="space-y-6">
                <div className="flex justify-between items-start">
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-600">
                      This service encompasses cut, shape, and NON GEL
                      colour application
                    </p>
                  </div>
                  <div className="text-right ml-4">
                ...
                <div className="flex justify-between items-start">
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-600">
                      Indulge in sea-salt soaking, cuticle care, foot scrub, and
                      lotion massage, followed by NON GEL colour application.
                    </p>
                  </div>
                  <div className="text-right ml-4">
                    <span className="font-bold">$38.15</span>
                ...
                <div className="flex justify-between items-start">
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-600">
                      This service includes cut, shape, and GEL colour
                      application for a long-lasting finish.
                    </p>
                  </div>
                  <div className="text-right ml-4">
                    <span className="font-bold">$38.15</span>
                ...
                <div className="flex justify-between items-start">
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-600">
                      Enjoy an all-inclusive pedicure service with cut, shape,
                      sea-salt soaking, cuticle care, foot scrub, lotion massage,
                      and GEL colour application.
                    </p>
                  </div>
                  <div className="text-right ml-4">
                ...
                <div className="flex justify-between items-start">
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-600">
                      Relieve pressure and pain caused by ingrown nails with
                      our gentle, hygienic care. Designed to reduce
                      inflammation and support healthy nail growth.
                    </p>
                  </div>
                  <div className="text-right ml-4">
                ...
                <div className="flex justify-between items-start">
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-600">
                      A targeted solution for early-stage fungal infections.
                      Helps restore nail clarity and prevent further spread —
                      clean, safe, and professionally handled.
                    </p>
                  </div>
                  <div className="text-right ml-4">
                ...
                <div className="flex justify-between items-start">
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-600">
                      For thick, hard dead skin/corn offering callus medicine,
                      extra foot scrub, and paraffin treatment.
                    </p>
                  </div>
                  <div className="text-right ml-4">
                    <span className="font-bold">$30.52</span>
                ...
                <div className="flex justify-between items-start">
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-600">
                      Specially designed to manage the condition and improve
                      the quality of life for those affected by eczema.
                    </p>
                  </div>
                  <div className="text-right ml-4">
                    <span className="font-bold">$27.25</span>
                ...
                <div className="flex justify-between items-start">
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-600">
                      A 5-step luxury nourishing spa with a hot steaming
                      machine combined, restoring smooth, radiant skin and
                      providing ample moisture for your hands and feet.
                    </p>
                  </div>
                  <div className="text-right ml-4">
                    <span className="font-bold">$30.52</span>
          ...
          <div className="mt-16">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                ...
                Each concept offers its own emotional landscape — guided by color, scent, texture, and a signature refreshment served at the end as the final note of the ritual.
            ...
            <div className="grid lg:grid-cols-2 gap-8">
              ...
              <div className="bg-white rounded-3xl p-8 shadow-lg">
                <div className="aspect-video bg-gray-200 rounded-2xl mb-6 overflow-hidden">
                  <img 
                    src="/assets/pricing/spa/matcha-lover.jpg"
                    alt="Matcha Lover Spa Treatment"
                    className="w-full h-full object-cover"
                  />
                </div>
                ...
                <p className="text-gray-600 mb-4">
                  Matcha Lover captures the serenity of a Japanese morning: soft green hues, gentle warmth on the skin, and a subtle scent that invites stillness.
                  A velvety matcha mask embraces the hands and feet, while slow, intentional massage strokes embody the art of slow beauty — unhurried, grounding, and deeply pure.
                </p>
              ...
              <div className="bg-white rounded-3xl p-8 shadow-lg">
                <div className="aspect-video bg-gray-200 rounded-2xl mb-6 overflow-hidden">
                  <img 
                    src="/assets/pricing/spa/whisper-rosy.jpg"
                    alt="Roselle Spa Treatment"
                    className="w-full h-full object-cover"
                  />
                </div>
                ...
                <p className="text-gray-600 mb-4">
                  Roselle blends the clarity of roselle red with the refined femininity of rose petals — a modern, effortless elegance.
                  A delicate rose mask soothes the skin, while the refining scrub brings back its natural softness and radiance.
                </p>
                <p className="text-gray-600 mb-6">
              ...
              <div className="bg-white rounded-3xl p-8 shadow-lg">
                <div className="aspect-video bg-gray-200 rounded-2xl mb-6 overflow-hidden">
                  <img 
                    src="/assets/pricing/spa/golden-expresso.jpg"
                    alt="Golden Espresso Spa Treatment"
                    className="w-full h-full object-cover"
                  />
                </div>
                ...
                <p className="text-gray-600 mb-4">
                  Golden Espresso is inspired by the quiet luxury of slow, warm mornings.
                  A coffee-based scrub awakens the skin and stimulates circulation, creating a comforting warmth across the hands and feet. The nourishing mask that follows enhances softness and vitality.
                </p>
                <p className="text-gray-600 mb-6">
              ...
              {/* Mint Cucumber Escape */}
              <div className="bg-white rounded-3xl p-8 shadow-lg">
                <div className="aspect-video bg-gray-200 rounded-2xl mb-6 overflow-hidden">
                  <img 
                    src="/assets/pricing/spa/cucumber-escape.jpg"
                    alt="Mint Cucumber Escape Spa Treatment"
                    className="w-full h-full object-cover"
                  />
                </div>
                ...
                <p className="text-gray-600 mb-4">
                  This treatment feels like stepping into a cool, airy garden: a hint of mint, a wash of green, and a refreshing clarity on the skin.
                  The mint mask melts fatigue away, soothing the hands and feet, while gentle massage strokes bring a sense of cleanliness and renewal.
                </p>
                <p className="text-gray-600 mb-6">
              ...
              <div className="bg-white rounded-3xl p-8 shadow-lg">
                <div className="aspect-video bg-gray-200 rounded-2xl mb-6 overflow-hidden">
                  <img 
                    src="/assets/pricing/spa/orange-sunset.jpg"
                    alt="Orange Creamy Spa Treatment"
                    className="w-full h-full object-cover"
                  />
                </div>
                ...
                <p className="text-gray-600 mb-4">
                  Orange Creamy radiates warmth and comfort from the very first touch of its soft citrus hue.
                  A nourishing orange mask adds moisture and lightness, while the rhythmic massage creates a cocoon of ease and contentment.
                </p>
                <p className="text-gray-600 mb-6">
              ...
              <div className="bg-white rounded-3xl p-8 shadow-lg">
                <div className="aspect-video bg-gray-200 rounded-2xl mb-6 overflow-hidden">
                  <img 
                    src="/assets/pricing/spa/seasonal-spa.jpg"
                    alt="Vanilla Creamy Spa Treatment"
                    className="w-full h-full object-cover"
                  />
                </div>
                ...
                <p className="text-gray-600 mb-4">
                A curated hand & foot spa experience that changes throughout the year.
                </p>
                <p className="text-gray-600 mb-6">
