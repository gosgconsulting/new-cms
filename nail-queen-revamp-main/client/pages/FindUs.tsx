        ...
        <div className="absolute z-30 top-1/2 right-8 transform -translate-y-1/2 pointer-events-auto">
          <div className="bg-white rounded-2xl p-8 shadow-2xl max-w-md">
            <div className="text-center space-y-6">
              {/* Find Us Title */}
              <h1 className="text-4xl font-bold text-nail-queen-brown mb-4">
                Find Us
              </h1>
              
              <div>
                <h3 className="text-2xl font-bold text-nail-queen-brown mb-2">
                  Address
                </h3>
                <p className="text-gray-600">
                  Unit #05-18/19/20 Far East Plaza, Singapore
                </p>
              </div>
              ...
              <div className="flex justify-center space-x-3 pt-4">
                ...
                {/* YouTube - Coming Soon */}
                <div className="w-10 h-10 bg-red-600 rounded-full flex items-center justify-center text-white opacity-50 cursor-not-allowed" title="YouTube - Coming Soon">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
