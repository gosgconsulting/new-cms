...
import Footer from "../../e-shop/components/footer/Footer";
import CheckoutHeader from "../../e-shop/components/header/CheckoutHeader";
...
export default function CheckoutPage() {
  ...
  // NOTE: Images are imported so the theme works under any slug (e.g. /theme/moondk)
  // without needing /theme/<slug>/assets.
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          handleCustomerDetailsChange("firstName", e.target.value)
                        }
                        className="mt-2 rounded-none"
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          handleCustomerDetailsChange("lastName", e.target.value)
                        }
                        className="mt-2 rounded-none"
                    ...
                    <div className="space-y-6 pt-4">
                      ...
                      <div>
                        ...
                        <Input
                          ...
                          onChange={(e) =>
                            handleBillingDetailsChange("address", e.target.value)
                          }
                          className="mt-2 rounded-none"
                          placeholder="Street address"
                        />
                      ...
                      <div>
                        ...
                        <Input
                          ...
                          onChange={(e) =>
                            handleBillingDetailsChange("country", e.target.value)
                          }
                          className="mt-2 rounded-none"
                          placeholder="Country"
                        />
