...
export const products: Product[] = [
  ...
  { id: 2, name: "Corn Extract (옥미수)", category: "Ingredients", price: "€28", image: cornExtractImage },
  { id: 3, name: "Black Bean Tea Extract (검은콩차 진액)", category: "Ingredients", price: "€22", image: blackBeanTeaImage },
  { id: 4, name: "Barley Tea Extract (보리차 진액)", category: "Ingredients", price: "€18", image: barleyTeaImage },
];
