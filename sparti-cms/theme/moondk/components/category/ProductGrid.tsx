...
function categoryPastelBg(category: string) {
  ...
  const map: Record<string, string> = {
    "Curated Sets": "bg-[#E43AA6]",
    Ingredients: "bg-[#FFD6E8]",
    Tools: "bg-[#EED9FF]",
    Essentials: "bg-[#DDFCC9]",
    "Recipe Collections": "bg-[#FFE7C7]",
  };
        ...
        {products.map((product) => (
          <div key={product.id} className="w-full">
            ...
            <div className="mt-6">
              ...
              >
                <ThemeLink to={`/product/${product.id}`} className="flex items-center justify-center gap-2">
                  <span>Shop Now</span>
