      ...
      <DialogContent className="sm:max-w-md !rounded-none bg-background border-border-light">
        ...
        <div className="space-y-6">
          <div className="space-y-3">
            <label className="text-sm font-body font-light text-foreground">Rating</label>
          ...
          <div className="space-y-3">
            <label className="text-sm font-body font-light text-foreground">Your review</label>
            <Textarea
              value={review}
