...
const sampleProduct = {
  id: "prod-001",
  name: "Moondk Starter Pack",
  price: "SGD 99",
  image: "/placeholder.svg",
  description:
    "A simple starter product to preview the Moondk theme. We’ll connect real product data later.",
