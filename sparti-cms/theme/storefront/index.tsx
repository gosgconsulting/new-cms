...
/**
 * Storefront Theme (based on Master Theme pattern)
 * Renders a simple header/footer and switches between Homepage and Shop
 * using the optional pageSlug from the route.
 */
