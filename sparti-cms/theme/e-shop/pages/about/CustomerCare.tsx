            ...
            <Accordion type="single" collapsible className="space-y-4">
              <AccordionItem value="shipping" className="border border-border rounded-lg px-6">
                ...
                <AccordionContent className="text-muted-foreground">
                  ...
                  shipping (1-2 business days) is available for $25. All orders are fully insured and
          ...
          <ContentSection title="Contact Form">
            <form className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <Textarea className="rounded-none min-h-[120px]" placeholder="Please describe your inquiry in detail" />
              </div>
