              ...
              <div className="bg-muted/20 p-8 rounded-none">
                ...
                <RadioGroup value={shippingOption} onValueChange={setShippingOption} className="space-y-4">
                  <div className="flex items-center justify-between p-4 border border-muted-foreground/20 rounded-none">
                    ...
                    <div className="text-sm text-muted-foreground">Free • 3-5 business days</div>
                  </div>
                  ...
                  <div className="flex items-center justify-between p-4 border border-muted-foreground/20 rounded-none">
                    ...
                    <div className="text-sm text-muted-foreground">€15 • 1-2 business days</div>
                  </div>
                  ...
                  <div className="flex items-center justify-between p-4 border border-muted-foreground/20 rounded-none">
                    ...
                    <div className="text-sm text-muted-foreground">€35 • Next business day</div>
                  </div>
                </RadioGroup>
              </div>
