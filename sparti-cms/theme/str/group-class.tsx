        ...
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="max-w-4xl mx-auto">
            <div className="bg-white rounded-3xl p-8 md:p-12 shadow-2xl relative overflow-hidden">
              {/* Orange Accent Bar */}
              <div className="absolute top-0 left-0 w-full h-2 bg-[#E48D2A]"></div>
              ...
              <div className="mt-4">
                ...
                <div className="mb-8 space-y-3">
                  <div className="flex items-center gap-3">
                    <div className="w-2 h-2 rounded-full bg-[#E48D2A]"></div>
                ...
                <div className="mb-8">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {[
                      ...
                      >
                        <div className="w-1.5 h-1.5 rounded-full bg-[#E48D2A]"></div>
