...
const GroupClassPage: React.FC<TenantLandingProps> = ({
  ...
  return (
    <div className="str-theme min-h-screen bg-background text-foreground">
      ...
      {/* Main Services Section - 2 Weeks Unlimited */}
      <section id="services" className="py-16 sm:py-20 px-4 sm:px-6 lg:px-8 bg-background relative overflow-hidden">
        <div className="container mx-auto max-w-6xl">
          ...
          {/* Main Service Card - 2 Weeks Unlimited */}
          <div className="max-w-4xl mx-auto">
            <div className="bg-white rounded-3xl p-8 md:p-12 shadow-2xl relative overflow-hidden">
              {/* Red Accent Bar */}
              <div className="absolute top-0 left-0 w-full h-2 bg-[#E00000]"></div>
              
              {/* Badge for First Time Sign-ups */}
              <div className="absolute top-6 right-6 bg-[#E00000] text-white px-4 py-2 rounded-full text-sm font-bold uppercase">
                First Time Sign-ups
              </div>
              ...
              <div className="mt-4">
                ...
                {/* Price */}
                <div className="mb-6">
                  <span className="text-5xl md:text-6xl font-bold text-[#E00000]">$99</span>
                </div>

                {/* Credits and Validity */}
                <div className="mb-8 space-y-3">
                  <div className="flex items-center gap-3">
                    <div className="w-2 h-2 rounded-full bg-[#E00000]"></div>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <p className="text-black/80 text-lg">
                      Valid for <span className="font-semibold">2 weeks</span> from date of first class
                    </p>
                  </div>
                </div>
                ...
                {/* Eligible Classes */}
                <div className="mb-8">
                  <h4 className="text-xl md:text-2xl font-bold uppercase text-black mb-6">
                    Eligible Classes
                  </h4>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {[
                      ...
                      'STR Build Lower',
                      'STR Build Upper',
                      'STR Conditioning 1.1',
                      'STR Conditioning 1.2',
                      'STR Squad'
                    ].map((className, index) => (
                      <div
                        key={index}
                      ...
                      >
                        <div className="w-1.5 h-1.5 rounded-full bg-[#E00000]"></div>
                        <span className="text-black font-medium">{className}</span>
                      </div>
                    ))}
                  </div>
                </div>
                ...
                <Button
                  size="lg"
                  className="w-full bg-[#E00000] text-white hover:bg-[#E00000]/90 text-lg px-8 py-6 font-bold uppercase rounded-lg transition-all duration-300 hover:scale-105"
                  onClick={() => setIsContactModalOpen(true)}
                >
                  Get Started Today
                </Button>
          ...
          <div className="mt-12 text-center">
            <p className="text-foreground/60 text-sm max-w-2xl mx-auto">
              Perfect for first-time visitors who want to experience the full range of STR group classes. This package gives you the flexibility to try different class types and find what works best for your fitness goals.
            </p>
          </div>
        </div>
      </section>
