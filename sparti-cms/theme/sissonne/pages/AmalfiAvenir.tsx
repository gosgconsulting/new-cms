...
export default function AmalfiAvenir() {
  ...
  return (
    ...
    >
      ...
      <style>{`
        .font-heading { font-family: 'Amalfi Coast', serif !important; }
        .font-body { font-family: 'Avenir', sans-serif !important; }
        h1, h2, h3, h4, h5, h6 { font-family: 'Amalfi Coast', serif !important; }
        body { font-family: 'Avenir', sans-serif !important; }
        p, span, div:not([class*="font-heading"]) { font-family: 'Avenir', sans-serif !important; }
        
        /* Hero banner specific fonts */
        .hero-title { font-family: 'Baskerville', 'Times New Roman', 'Georgia', serif !important; }
        .hero-subtitle { 
          font-family: 'Amalfi Coast', serif !important; 
          font-size: 1.75rem !important;
          margin-top: 1rem !important;
        }
        .hero-body { font-family: 'Avenir', -apple-system, BlinkMacSystemFont, sans-serif !important; }
        
        /* Override specific elements to use Avenir instead of Amalfi Coast */
        .program-name { font-family: 'Avenir', -apple-system, BlinkMacSystemFont, sans-serif !important; }
        .form-title { font-family: 'Avenir', -apple-system, BlinkMacSystemFont, sans-serif !important; }
        .font-body.font-medium { font-family: 'Avenir', -apple-system, BlinkMacSystemFont, sans-serif !important; }
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2
              ...
              style={{ fontFamily: "'Amalfi Coast', serif" }}
            >
                ...
                <div className="grid md:grid-cols-2 gap-12 items-center">
                  <div>
                    <div className="flex items-center space-x-3 mb-4">
                      <h3
                        className="text-3xl font-bold text-dance-pink program-name"
                      >
                        {program.name}
                      </h3>
            ...
            <div className="bg-dance-white rounded-3xl shadow-2xl overflow-hidden">
              <div className="grid lg:grid-cols-2 gap-0">
                ...
                <div className="p-8 lg:p-12 flex flex-col justify-center">
                  <div className="mb-8">
                    <h3
                      className="text-3xl lg:text-4xl font-bold text-dance-black mb-4 form-title"
                    >
                      Book A Trial
                    </h3>
