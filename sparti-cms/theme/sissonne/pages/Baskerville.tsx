...
export default function Baskerville() {
  ...
  return (
    ...
    >
      ...
      <style>{`
        .font-heading { font-family: 'Libre Baskerville', serif !important; }
        .font-body { font-family: 'Inter', sans-serif !important; }
        h1, h2, h3, h4, h5, h6 { font-family: 'Libre Baskerville', serif !important; }
        body { font-family: 'Inter', sans-serif !important; }
        p, span, div:not([class*="font-heading"]) { font-family: 'Inter', sans-serif !important; }
      `}</style>
