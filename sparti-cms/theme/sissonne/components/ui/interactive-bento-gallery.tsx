...
const GalleryModal = ({ selectedItem, isOpen, onClose, setSelectedItem, mediaItems }: GalleryModalProps) => {
    ...
    return (
        <>
            ...
            >
                ...
                <motion.button
                    className="absolute top-2 sm:top-2.5 md:top-3 right-2 sm:right-2.5 md:right-3 
                              p-2 rounded-full bg-dance-white/90 text-dance-black hover:bg-dance-white 
                              text-xs sm:text-sm backdrop-blur-sm shadow-lg"
                    onClick={onClose}
            ...
            >
                <motion.div
                    className="relative rounded-xl bg-dance-pink/20 backdrop-blur-xl 
                             border border-dance-pink/30 shadow-lg
    ...
    return (
        <div className="w-full">
            <div className="mb-8 text-center">
                <motion.h1
                    className="text-2xl sm:text-3xl md:text-4xl font-heading font-bold text-dance-white"
                ...
                <motion.p
                    className="mt-2 text-sm sm:text-base font-body font-light text-dance-gray-200"
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
