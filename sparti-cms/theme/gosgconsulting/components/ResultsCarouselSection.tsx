      ...
      <div className="mx-auto max-w-7xl">
        <div className="relative">
          ...
          >
            ...
            {studies.length > 1 && (
              <>
                <CarouselPrevious className="absolute -left-12 md:-left-16 top-1/2 -translate-y-1/2 h-12 w-12 rounded-lg bg-teal-500 hover:bg-teal-600 text-white border-0 shadow-lg">
                  <ChevronLeft className="h-6 w-6" />
                </CarouselPrevious>
                <CarouselNext className="absolute -right-12 md:-right-16 top-1/2 -translate-y-1/2 h-12 w-12 rounded-lg bg-teal-500 hover:bg-teal-600 text-white border-0 shadow-lg">
