...
export default {
  ...
  theme: {
    ...
    extend: {
      fontFamily: {
        heading: ["Playfair Display", "serif"], // Main headlines - elegant and sophisticated
        "heading-cursive": ["Playfair Display", "serif"], // Same as main heading for consistency
        body: ["Source Sans Pro", "sans-serif"], // Thin, classy body text similar to Pei's font
        handwriting: ["Dancing Script", "cursive"], // Family-related text
      ...
      colors: {
        ...
        // Pink and White Dance Academy Colors
        dance: {
