...
export default function EbGaramond() {
  ...
  return (
    ...
    >
      ...
      <style>{`
        .font-heading { font-family: 'EB Garamond', serif !important; }
        .font-body { font-family: 'Nunito Sans', sans-serif !important; }
        h1, h2, h3, h4, h5, h6 { font-family: 'EB Garamond', serif !important; }
        body { font-family: 'Nunito Sans', sans-serif !important; }
        p, span, div:not([class*="font-heading"]) { font-family: 'Nunito Sans', sans-serif !important; }
      `}</style>
