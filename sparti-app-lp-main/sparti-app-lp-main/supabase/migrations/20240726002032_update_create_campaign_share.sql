...
BEGIN
  ...
  v_slug := public.generate_campaign_share_slug();

  INSERT INTO public.campaign_shares (slug, brand_id, campaign_id, created_by)
  VALUES (v_slug, p_brand_id, p_campaign_id, v_user)
