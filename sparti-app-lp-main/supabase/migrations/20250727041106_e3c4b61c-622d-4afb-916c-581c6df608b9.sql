...
-- Supabase Postgres does not support IF NOT EXISTS for CREATE POLICY; ensure idempotency with DO $$ ... $$ if needed
DO $$ BEGIN
  IF NOT EXISTS (
...
-- Update the feedback summary function to include rating data
