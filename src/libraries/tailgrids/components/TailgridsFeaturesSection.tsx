...
interface TailgridsFeaturesSectionProps {
  component: ComponentSchema;
  className?: string;
}

/**
 * Tailgrids Features Section Component
 * 
 * Features grid with icons, titles, and descriptions
 * Uses Tailgrids/Tailwind CSS styling
 */
const TailgridsFeaturesSection: React.FC<TailgridsFeaturesSectionProps> = ({
  component,
  className = "",
}) => {
...
export default TailgridsFeaturesSection;
