    ...
    >
      <div className="relative z-10 flex flex-col items-center">
        ...
        <h1 className="max-w-3xl bg-gradient-to-br from-white to-gray-400 bg-clip-text text-center text-3xl font-medium leading-tight text-transparent sm:text-5xl sm:leading-tight md:text-7xl md:leading-tight">
          Digital Marketing Made Accessible
        </h1>
        <p className="my-6 max-w-xl text-center text-base leading-relaxed md:text-lg md:leading-relaxed">
          We are an integrated digital marketing agency sharing tips, case studies, best practices, and guides through our blog articles. Our mission is to make digital marketing accessible and transparent for everyone.
        </p>
        <motion.button
          style={{
            border,
