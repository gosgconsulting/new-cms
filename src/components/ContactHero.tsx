...
export const ContactHero = () => {
  ...
  return (
    <motion.section
      ...
      className="relative grid min-h-[70vh] place-content-center overflow-hidden bg-deepBlue px-4 pt-32 pb-24 text-gray-200"
    >
      <div className="relative z-10 flex flex-col items-center">
        ...
        <p className="my-6 max-w-xl text-center text-base leading-relaxed md:text-lg md:leading-relaxed">
          Have questions about our services or want to discuss your marketing needs? Fill out the form, and we'll get back to you shortly.
        </p>
        <motion.button
          style={{
            border,
