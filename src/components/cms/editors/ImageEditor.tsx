...
import { SpartiElement } from '@/types/cms';
import { uploadFile } from '@/utils/cms/uploadToBlob';
import { 
  Image as ImageIcon, 
  Upload, 
  Link as LinkIcon, 
...
export const ImageEditor: React.FC<ImageEditorProps> = ({ selectedElement }) => {
  ...
  // Media library functionality (placeholder for future implementation)
  const loadMediaLibrary = async () => {
    // TODO: Load media library from server API
    console.log('[testing] Media library loading - to be implemented');
  };
