...
const Footer = ({ onContactClick }: FooterProps) => {
  // Use /thank-you as an intermediate redirect page for tracking.
  // It will then redirect to WhatsApp.
  const whatsappPhone = "1234567890";
  const whatsappMessage = "Hi! I'd like to enquire.";
  const whatsappTrackingUrl = `/thank-you?via=whatsapp&phone=${encodeURIComponent(
    whatsappPhone
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start mb-12">
          ...
          <div className="space-y-6">
            ...
            <p className="text-gray-300 text-lg mb-6">
              Ready to dominate search results? Let's discuss how we can help your
              business grow.
            </p>
          ...
          <div className="lg:text-right">
            ...
            <div className="space-y-3">
              <a
                ...
                onClick={(e) => {
                  // If the page has a Contact Us modal, open that first (so we capture details)
                  // then the user can choose WhatsApp inside the flow.
                  if (onContactClick) {
                    e.preventDefault();
                    onContactClick();
                  }
        ...
        <div className="pt-8 border-t border-gray-700">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <div className="flex flex-wrap justify-center md:justify-start gap-6 text-sm text-gray-400">
              <Link to="/dashboard" className="hover:text-brandTeal transition-colors">
                Home
              </Link>
              <Link to="/blog" className="hover:text-brandTeal transition-colors">
                Blog
              </Link>
              <Link
                to="#"
