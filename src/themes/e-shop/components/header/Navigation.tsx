  ...
  const navItems = [
    {
      ...
      images: [
        { src: pantheonImage, alt: "Rings", label: "Rings", to: "/category/rings" },
        { src: haloImage, alt: "Earrings", label: "Earrings", to: "/category/earrings" },
      ],
    },
    {
      name: "New in",
      ...
      images: [
        {
          ...
          to: "/product/arcus-bracelet",
        },
        {
          src: pantheonImage,
          alt: "Span Bracelet",
          label: "Span Bracelet",
          to: "/product/span-bracelet",
        },
      ],
    },
    {
      ...
      images: [
        { src: foundersImage, alt: "Company Founders", label: "Read our story", to: "/about/our-story" },
      ],
    },
  ];
