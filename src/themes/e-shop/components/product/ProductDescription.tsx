        ...
        {isDescriptionOpen && (
          <div className="pb-6 space-y-4">
            <p className="text-sm font-light text-muted-foreground leading-relaxed">
              The Pantheon earrings embody architectural elegance with their clean, geometric
              design. Inspired by classical Roman architecture, these statement pieces feature
              a sophisticated interplay of curves and angles that catch and reflect light
              beautifully.
            </p>
            <p className="text-sm font-light text-muted-foreground leading-relaxed">
              Each earring is meticulously crafted from premium sterling silver with an 18k
              gold plating, ensuring both durability and luxury. The minimalist aesthetic
              makes them perfect for both everyday wear and special occasions.
            </p>
          </div>
        )}
      </div>
        ...
        {isCareOpen && (
          <div className="pb-6 space-y-4">
            ...
            <p className="text-sm font-light text-muted-foreground">
              For professional cleaning, visit your local jeweler or contact our customer
              service team.
            </p>
          </div>
        )}
          ...
          <div className="pb-6 space-y-6">
            ...
            <div className="space-y-6">
              <div className="space-y-3">
                ...
                <p className="text-sm font-light text-muted-foreground leading-relaxed">
                  "Absolutely stunning earrings! The quality is exceptional and they go with
                  everything. The architectural design is so unique and I get compliments every
                  time I wear them."
                </p>
              </div>
              ...
              <div className="space-y-3">
                ...
                <p className="text-sm font-light text-muted-foreground leading-relaxed">
                  "Beautiful craftsmanship and comfortable to wear all day. The gold plating has
                  held up perfectly after months of regular wear. Highly recommend!"
                </p>
              </div>
              ...
              <div className="space-y-3">
                ...
                <p className="text-sm font-light text-muted-foreground leading-relaxed">
                  "These earrings are a work of art. The minimalist design is elegant and
                  sophisticated. Perfect weight and the packaging was beautiful too."
                </p>
              </div>
            </div>
          </div>
