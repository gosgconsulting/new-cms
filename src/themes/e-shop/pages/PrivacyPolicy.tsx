          ...
          <div className="prose prose-lg max-w-none space-y-8">
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                At Linea Jewelry Inc. ("we," "our," or "us"), we respect your privacy and are committed
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                through your browser preferences, though this may affect website functionality.
              </p>
            </section>
