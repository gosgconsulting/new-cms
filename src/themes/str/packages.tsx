...
import { useThemeBranding } from '@/hooks/cms/useThemeSettings';
...
const PackagesPage: React.FC<TenantLandingProps> = ({
  tenantName = 'STR',
  tenantSlug = 'str',
  tenantId
}) => {
  ...
  const siteDescription = getSiteDescription(branding, 'Packages - STR Fitness Club');
  ...
  const pageMeta = useMemo(() => ({
    ...
    keywords: 'STR Fitness, packages, fitness memberships, Singapore',
  ...
  return (
    <div className="str-theme min-h-screen bg-background text-foreground">
      ...
      <main className="pt-0">
            ...
            <div className="flex flex-col md:flex-row items-center justify-between gap-4">
              <div className="flex-1 text-center md:text-left">
                ...
                <p className="text-foreground/80 text-sm md:text-base">
                  Have questions about our packages? Our team is here to assist you.
                </p>
              </div>
              <Button
        ...
        <iframe 
          src="https://bookings.vibefam.com/strfitnessclub/packages#widget" 
          style={{ height: 'calc(100dvh - 120px)' }} 
          width="100%" 
          frameBorder="0" 
          height="700px"
          title="STR Fitness Packages"
        />
      </main>
