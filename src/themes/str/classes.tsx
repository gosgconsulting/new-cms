...
const ClassesPage: React.FC<TenantLandingProps> = ({
  ...
  const siteDescription = getSiteDescription(branding, 'Classes - STR Fitness Club');
  ...
  const pageMeta = useMemo(() => ({
    title: `Classes - ${siteName}`,
    description: siteDescription,
    keywords: 'STR Fitness, classes, fitness classes, Singapore',
