...
const ServiceHero = ({ title, description, image, onContactClick }: ServiceHeroProps) => {
  return (
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              ...
              <Button 
                ...
                className="w-full sm:w-auto justify-center bg-gradient-to-r from-purple-500 to-teal-500 hover:from-purple-600 hover:to-teal-600 text-white font-medium px-6 py-3 rounded-2xl transition-all duration-300 shadow-lg hover:shadow-xl cursor-pointer"
              >
                Learn More
                {/* WP: <?php echo get_field('cta_primary_text', 'option') ?: 'Learn More'; ?> */}
              </Button>
              <Button 
                onClick={onContactClick}
                className="w-full sm:w-auto justify-center bg-gradient-to-r from-purple-500 to-teal-500 hover:from-purple-600 hover:to-teal-600 text-white font-medium px-6 py-3 rounded-2xl transition-all duration-300 shadow-lg hover:shadow-xl cursor-pointer"
              >
                ...
                Learn More
                {/* WP: <?php echo get_field('cta_secondary_text', 'option') ?: 'Learn More'; ?> */}
              </Button>
            </div>
          </motion.div>
