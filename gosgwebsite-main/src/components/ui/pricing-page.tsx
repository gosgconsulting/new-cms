...
import { starterContent, growthContent, accelerateContent } from "@/data/pricingContent";
    ...
    >
      ...
      <div className="mt-auto">
        <button 
          ...
          className="w-full h-12 bg-white rounded-lg text-neutral-900 font-bold hover:bg-neutral-200 transition-colors"
        >
          {buttonText}
        </button>
      </div>
...
const PricingPage: React.FC = () => {
  const starterPlan: PricingCardProps = {
    ...
    features: [
      ...
      { category: "Perfect for", items: ["Early-stage businesses", "No online presence yet", "Lead-generation beginners"] }
    ],
  ...
  const proPlan: PricingCardProps = {
    ...
    features: [
      ...
      { category: "Automation", items: ["Choose WhatsApp follow-up OR Email follow-up campaign"] },
      { category: "Perfect for", items: ["Businesses with a site but no results", "Low-traffic brands", "Scaling paid ads efficiently"] }
    ],
    buttonText: "Get Started",
    isPopular: true,
  };
  ...
  const enterprisePlan: PricingCardProps = {
    ...
    features: [
      ...
      { category: "Organic Growth", items: ["10 premium SEO backlinks / month", "12 SEO-optimized authority articles / month"] },
      { category: "Automation", items: ["WhatsApp + Email drip-follow-up sequences"] },
      { category: "Perfect for", items: ["Companies chasing market leadership", "Aggressive monthly growth targets", "Brands wanting maximum traffic + conversion"] }
    ],
    buttonText: "Get Started",
    isPopular: false,
  };
