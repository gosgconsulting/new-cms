...
import WeDoItAllCallout from "@/components/ui/we-do-it-all-callout";
      ...
      <HeroHighlight containerClassName="h-[50rem] py-20 md:py-24 relative">
        ...
        <div className="container mx-auto max-w-5xl px-4 relative z-10">
          <div className="flex flex-col items-center text-center">
            {/* Logo and Label Column - much more top spacing on mobile */}
            <div className="flex flex-col items-center gap-3 self-center mb-8 md:mb-4 mt-16 md:mt-0">
              {/* GO SG Logo - ensure visibility on mobile */}
              <div
                role="button"
                aria-label="GO SG Consulting"
                className="inline-flex items-center justify-center cursor-pointer hover:opacity-80 transition"
              >
                <img
                  src={gosgLogo}
              ...
              {/* Dotted Border Label Below Logo */}
